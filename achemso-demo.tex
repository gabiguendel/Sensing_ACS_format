...
\centering
   \includegraphics[width=0.5\textwidth]{Images/NTset5TM-addphase038B.png}\\
    \includegraphics[width=0.475\textwidth]{Images/TEM_NT_ratio_038B.png}
...
\begin{figure}[H]
\centering
   \includegraphics[width=0.5\textwidth]{Images/Rre_semilog_NT91B.png}\\
   \includegraphics[width=0.5\textwidth]{Images/Rim_semilog_NT6_b1.png}
